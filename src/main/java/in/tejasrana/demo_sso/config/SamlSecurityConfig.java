package in.tejasrana.demo_sso.config;

import in.tejasrana.demo_sso.authentication.CustomSAMLAuthenticationProvider;
...
public class SamlSecurityConfig {
    ...
    public ExtendedMetadataDelegate oktaExtendedMetadataProvider() throws MetadataProviderException {
        ...
        try {
            resource = new ClasspathResource("/saml/metadata/okta-dev.xml");
